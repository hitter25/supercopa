...
import { testSupabaseConnection, testSupabaseHealth } from '../services/supabaseService';
...
const SupabaseTest: React.FC = () => {
  ...
  const handleTestHealth = async () => {
    ...
    try {
      const healthResult = await testSupabaseHealth();
  ...
  return (
    <div className="fixed top-4 right-4 z-50 max-w-md">
      ...
      >
        <h2 className="text-xl font-bold mb-4 text-white">Teste de Conexão Supabase</h2>
